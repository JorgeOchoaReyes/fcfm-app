    ...
    <View style={styles.container}>
      <View style={styles.header}>
        <View>
          ...
          <Text style={{fontSize: 12, color: "#4A90E2"}}>Version: 12:55 02/24/2026 </Text>
          <Text style={{fontSize: 12, color: "#4A90E2"}}>Current time: {`${new Date().getHours()}:${new Date().getMinutes()}:${new Date().getSeconds()}`} </Text>
        </View>
      ...
      <View style={{flexDirection: "row-reverse", justifyContent: "space-around", alignItems: "center"}} > 
        <View style={{
          ...
          <TouchableOpacity style={{
            ...
            setDateOfStorage(new Date().getDate() + 1);
          }}>
            <Text style={{...styles.sectionTitle, color: "white"}}>Update Date of Storage</Text>
          </TouchableOpacity>
        </View> 
